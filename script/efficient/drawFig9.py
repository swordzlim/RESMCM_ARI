...
algorithms = ["RS-estimator", "MetaAC", "MNC", "DMap", "LGraph"]

file_suffix = {
    "RS-estimator": 'resmcm_eff',
    "MetaAC": 'meta_eff',
    "MNC": 'mnc_eff',
    "DMap": 'dm_eff',
    "LGraph": 'lg_eff',
...
fig.text(0.5, 0.01, 'Fig. 9. Runtime of all sparsity estimators for SMCM on all datasets.', ha='center', fontsize=28)
...
root = os.path.abspath(".")
plt.savefig(root + '/../../materials/output/fig/fig_9_runtime_of_estimators_on_all_datasets.png', dpi=300)
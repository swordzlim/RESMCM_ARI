...
const string IMDB_ROOT = ROOT + "HINTrussICDE2020/IMDB/";
const string IMDB_GRAPH = IMDB_ROOT + "graph.txt";
const string IMDB_VERTEX = IMDB_ROOT + "vertex.txt";
const string IMDB_EDGE = IMDB_ROOT + "edge.txt";
...
int main(int argc, char **argv){
    ...
    p->vt = 0;
    p->nb_nds.emplace_back(a);
    p->nb_ets.emplace_back(0);
    p->nb_nds.emplace_back(v);
    p->nb_ets.emplace_back(1);
    p->nb_nds.emplace_back(t);
    p->nb_ets.emplace_back(2);

    a->vt = 1;
    a->nb_nds.emplace_back(p);
    a->nb_ets.emplace_back(3);
    
    v->vt = 2;
    v->nb_nds.emplace_back(p);
    v->nb_ets.emplace_back(4);
    
    t->vt = 3;
    t->nb_nds.emplace_back(p);
    t->nb_ets.emplace_back(5);

    vector<MetaPath> res;
    recursion(0, len, p, "", &res);

...
int main(int argc, char **argv){
    ...
    int len = 4;
    len = stoi(argv[1]);
    string input_graph = "../materials/input/graph/IMDB/graph.txt";
    string input_vertex = "../materials/input/graph/IMDB/vertex.txt";
    string input_edge = "../materials/input/graph/IMDB/edge.txt";
    ...
    try{
        ofstream outfile;
        outfile.open("../materials/input/metapath/IMDB/IMDB.txt");

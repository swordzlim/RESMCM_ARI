...
int main(int argc, char **argv){
    ...
    double iterations = 1;
    string input_graph = "../materials/input/graph/FourSquare/graph.txt";
    string input_vertex = "../materials/input/graph/FourSquare/vertex.txt";
    string input_edge = "../materials/input/graph/FourSquare/edge.txt";
    string input_meta_path = "../materials/input/metapath/FourSquare/FourSquare-l5.txt";
    string output_file = "../materials/output/efficient/FourSquare/rescsr_eff-l5-t64.txt";

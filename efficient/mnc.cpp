...
public:
    ...
    edge mnc_optimal_matrix_chain_order(vertex len, 
        ...
        struct timeval start_to, end_to;
        struct timeval start, end;
        gettimeofday(&start_to, NULL);
        ...
        gettimeofday(&end_to, NULL);
        dp_time = ((end_to.tv_sec - start_to.tv_sec) + (double)(end_to.tv_usec - start_to.tv_usec)/1000000.0) - es_time;
...
void SSP_dynamic(vector<HIN_nb> **HIN, BoolMatrix *&graph,
    ...
    rate es_nnz = dy_op->mnc_optimal_matrix_chain_order(p_l, matrices, n);

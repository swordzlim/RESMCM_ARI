...
void SSP_dynamic(vector<HIN_nb> **HIN, BoolMatrix *&graph,
    ...
    chain_order.emplace_back(0,1);
    for(int i = 2; i < p_l; i++){
        chain_order.emplace_back(-1,i);
    }
...
int main(int argc, char **argv){
    ...
    int thread_num = 64;
    double iterations = 1;
    vertex path_length = 4;
    string input_graph = "/home/chunxu/data/HINTrussICDE2020/DBLP/graph.txt";
    string input_vertex = "/home/chunxu/data/HINTrussICDE2020/DBLP/vertex.txt";
    string input_edge = "/home/chunxu/data/HINTrussICDE2020/DBLP/edge.txt";
    string input_meta_path = "/home/chunxu/cxx/exp_len/materials/DBLP/input/p_l" + to_string(path_length) + "/DBLP" + to_string(path_length) + ".txt";
    string output_file = "/home/chunxu/cxx/exp_len/materials/DBLP/dp_exp/p" + to_string(thread_num) + "/p_l"+  to_string(path_length) +"/test_SSP_v3_dp_row_p" + to_string(thread_num) + ".txt";
    ...
    for(MetaPath meta_path: pathes){
        ...
        for(int i = 0; i < iterations; i++){
            ...
            if(i % 20 == 0){
                ...
                cout << "memory cost of " << i << "th process: " << (usage_after.ru_maxrss - usage_before.ru_maxrss)/1024.0 << " MB" << endl;
        ...
        cout << "memory cost of whole process: " << memory_usage_kb/1024.0 << " MB" << endl;
        cout << "memory cost of bitmap: " << sizeof(bool) * thread_num * HIN->n/1024.0/1024.0 << " MB" << endl;
        ...
        cout << endl;
        cout << "*\t time rate is: " << max_t_time / min_t_time << endl;
        ...
        cout << endl;
        cout << "*\t row rate is: " << max_t_row / min_t_row << endl;
